...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton searchHospitalButton = (ImageButton) findViewById(R.id.search_hospital_button);
        ImageButton medicineButton = (ImageButton) findViewById(R.id.medicine_button);
        ImageButton rankingButton = (ImageButton) findViewById(R.id.ranking_button);
        ImageButton suggestAHospitalButton = (ImageButton) findViewById(R.id.suggest_a_hospital_button);
        ImageButton findOnMapButton = (ImageButton) findViewById(R.id.search_on_map_button);
//        Button feedbackButton = (Button) findViewById(R.id.feedback_button);
//        Button aboutButton = (Button) findViewById(R.id.about_button);
        ImageButton govtInitiatives = (ImageButton) findViewById(R.id.govt_initiatives_button);
        ...
        suggestAHospitalButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//        });
        ...
        medicineButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Home.this, MedicineInfo.class);
                startActivity(intent);
            }
        });
...
//        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_signout) {
            ...
            String shareBody = "Share this app with your friends and family. Download OGD Health Directory App";
